...
import { ActivatedRoute } from '@angular/router'; //1 import d'ActivatedRoute d'Angular pour avoir accès à la route courante
...
export class DetailPokemonComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute) {} //1 injection de ActivatedRoute qui viens de l'import {ActivatedRoute} d'angular/router pour avoir accès à la route courante
